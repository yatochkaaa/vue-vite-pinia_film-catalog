...
<template>
  <div class="movie">
    <img :src="`https://image.tmdb.org/t/p/original${movie.poster_path}`" :alt="movie.original_title" class="movie-img">
    <div>
      ...
      <div class="movie-buttons" v-else>
        <button class="btn btn_green" @click="searchStore.addFavoriteMovie(movie)">
          Add
        </button>
      </div>
    </div>
